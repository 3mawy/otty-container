...
const UserPets = ({user}) => {
    return (<>
            {user?.ownedPets?.length > 0 &&
                <div className={" bg-orange-300 w-[100%] rounded-md grid max-w-[28rem] py-8 relative mx-auto shadow-md"}>
                        ...
                        <div className="h-24 bg-orange-200 my-2 items-center flex justify-between px-5">
                            <div className="flex items-center space-x-4">
                                ...
                                <img src={pet.image} alt={''}
                                     className="bg-orange-600 w-20 h-20 rounded-full object-cover "/>
